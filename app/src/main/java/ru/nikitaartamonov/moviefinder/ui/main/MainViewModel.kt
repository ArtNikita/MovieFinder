...
class MainViewModel : ViewModel(), MainContract.ViewModel {
    ...
    override val checkAndAskForPermissionsLiveData = _checkAndAskForPermissionsLiveData
    private val _showAccessLocationPermissionExplanationLiveData = MutableLiveData<Event<Boolean>>()
    override val showAccessLocationPermissionExplanationLiveData =
    ...
    override val requestPermissionLiveData = _requestPermissionLiveData
